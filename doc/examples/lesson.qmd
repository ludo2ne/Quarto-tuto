...
**bold** - *italic* - ***italicbold*** - `Script` - ~~strike~~

> Citation

[Orange text on black background]{.orange_black} by defining class *.orange_black* in file `style.css` at the project root.
...
### Diagrams with [Mermaid](https://mermaid.js.org/){target="_blank"}
